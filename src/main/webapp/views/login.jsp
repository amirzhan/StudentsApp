...
<nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">LOGIN PAGE</a>
                ...
                <form:form id = "loginForm" action="/login" method="post" modelAttribute="user">
                    <div class="control-group">
                        <div class="form-group floating-label-form-group controls">
                            <label>Login</label>
                            <form:input path="username" class="form-control" id="name" type="text" placeholder="Login" required-data-validation-required-message="Please enter your login." />
                    ...
                    <div class="control-group">
                        <div class="form-group floating-label-form-group controls">
                            ...
                            <form:input path="password" class="form-control" id="email" type="password" placeholder="Password" required-data-validation-required-message="Please enter your password." />
                            <p class="help-block text-danger"></p>
                        </div>
                    </div>
                    <p1 style="color:red;">
                    ...
                    <div class="form-group">
                        <input type="submit" class="btn btn-success btn-lg" id="sendMessageButton" value="Sign in">
                    </div>
                </form:form>
            </div>
        </div>
