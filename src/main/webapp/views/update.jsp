...
<nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">UPDATE INFORMATION PAGE</a>
                    ...
                    <table>
                        ...
                        <div class="control-group">
                            <div class="form-group floating-label-form-group controls">
                                <tr>
                                    <td>FIRST NAME : </td>
                                    <td><form:input path="fname" type="text" value="${fname}" /></td>
                                </tr>
                            </div>
                        </div>
                        <div class="control-group">
                            <div class="form-group floating-label-form-group controls">
                                <tr>
                                    <td>LAST NAME : </td>
                                    <td><form:input path="lname" type="text" value="${lname}" /></td>
                                </tr>
                            </div>
                        </div>
                        <div class="control-group">
