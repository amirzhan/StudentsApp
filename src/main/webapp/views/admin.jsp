        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item" style="color:white;">
                    <% out.print(((User)(session.getAttribute("userData"))).getUsername());%>
                </li>
                <li class="nav-item">
                        ...
                        <div class="control-group">
                            <div class="form-group floating-label-form-group controls">
                                <tr>
                                    ...
                                    <td><form:select path="specialty.id">
...
<table style="border-style:solid;border-width: 1px;border-color:black;">
    ...
    <tr>
        ...
        <td style="border-style:solid;border-width: 1px;border-color:black;">
            <% out.print(u.getSpecialty().getName());%>
        </td>
        <td style="border-style:solid;border-width: 1px;border-color:black;">
            <% out.print(u.getRole().getName());%>
        </td>
        <td style="border-style:solid;border-width: 1px;border-color:black;">
            <a href="/update?student_username=<%out.print(u.getUsername());%>">update</a>
        </td>
        <td style="border-style:solid;border-width: 1px;border-color:black;">
            <a href="/delete?student_username=<%out.print(u.getUsername());%>">delete</a>
        </td>
    </tr>
